...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxBar = dailyCounts.reduce((a, b) => a > b ? a : b);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _SummaryCard(value: words.length.toString(), label: "Jami so'z",
                    color: const Color(0xFF1A6B3C), icon: Icons.auto_stories),
                const SizedBox(width: 12),
                _SummaryCard(value: learned.toString(), label: "Yodlandi",
                    color: const Color(0xFF2196F3), icon: Icons.check_circle),
                const SizedBox(width: 12),
                _SummaryCard(value: notLearned.toString(), label: "Qolgan",
                    color: Colors.orange, icon: Icons.pending),
              ],
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("$learned yodlandi",
                        style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                      Text("$notLearned qoldi",
                        style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                    ],
                  ),
                ],
                              ...
                              bottomTitles: AxisTitles(
                                sideTitles: SideTitles(
                                  ...
                                  getTitlesWidget: (v, _) {
                                    ...
                                    return Text(days[day.weekday % 7],
